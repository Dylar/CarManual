...
class VideoInfo extends HiveObject {
  ...
  static VideoInfo fromMap(Map<String, dynamic> map) => VideoInfo(
        ...
        tags: List<String>.from(map[FIELD_TAGS] ?? []),
      );
  ...
  String get vidUrl =>
      "https://${EnvironmentConfig.domain}/videos/$brand/$model/$category/$name/$filePath";

  String get picUrl =>
      "https://${EnvironmentConfig.domain}/videos/$brand/$model/$category/$name/$imagePath";
