...
void main() {
  ...
  //   final memeDatabase = AppDatabase();
  //
  ...
  // });
  //
  // test('models test can not open twice - throws DatabaseOpenException',
  //     () async {
  //   final memeDatabase = AppDatabase();
  //   expect(memeDatabase.isOpen, isFalse);
  //   await memeDatabase.init();
  ...
  // });
  //
  // test('models test can not closed twice - throws DatabaseClosedException',
  //     () async {
  //   final memeDatabase = AppDatabase();
  //   expect(memeDatabase.isOpen, isFalse);
  //   await memeDatabase.init();
